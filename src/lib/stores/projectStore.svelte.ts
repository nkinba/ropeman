...
function createProjectStore() {
	...
	return {
		...
		set fileTree(v: FileNode | null) { fileTree = v; },

		get astMap() { return astMap; },
		set astMap(v: Map<string, ASTSymbol[]>) { astMap = v; },
		...
		get parsingProgress() { return parsingProgress; },
		set parsingProgress(v: { done: number; total: number }) { parsingProgress = v; },
